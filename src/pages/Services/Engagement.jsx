// src/pages/Services/Engagement.jsx
...
export default function Engagement() {
  return (
    <section className="min-h-screen bg-[#0a0a0a] text-white p-8 lg:p-20">
      ...
      <h1 className="mt-6 text-5xl lg:text-7xl font-serif italic tracking-tight">Engagement</h1>
      <p className="mt-4 max-w-2xl text-white/60 text-sm leading-relaxed">
        Capturing the raw, quiet moments of shared promises.
      </p>
    </section>
  );
}
