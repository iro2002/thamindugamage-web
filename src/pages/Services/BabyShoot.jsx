// src/pages/Services/BabyShoot.jsx
...
export default function BabyShoot() {
  return (
    <section className="min-h-screen bg-[#0a0a0a] text-white p-8 lg:p-20">
      ...
      <h1 className="mt-6 text-5xl lg:text-7xl font-serif italic tracking-tight">Baby Shoot</h1>
      <p className="mt-4 max-w-2xl text-white/60 text-sm leading-relaxed">
        Gentle, organic portraiture for your newest addition.
      </p>
    </section>
  );
}
