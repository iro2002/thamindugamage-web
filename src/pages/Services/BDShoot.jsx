...
import { Send, Zap, Clock, Sparkles, ArrowLeft } from "lucide-react";
...
const ServiceDetailTemplate = ({ title, category, description, image }) => {
  ...
  return (
    <div className="bg-[#050505] text-white selection:bg-orange-500/30 overflow-x-hidden font-sans">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-7">
            <h2 className="text-[10px] uppercase tracking-[0.5em] text-white/30 mb-6 md:mb-8 font-bold">The Party</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 pt-10 border-t border-white/5">
                <div className="space-y-3">
                  <div className="text-orange-500"><Zap size={20} /></div>
                  <h4 className="text-[11px] uppercase tracking-widest font-bold text-white">Pure Energy</h4>
                  <p className="text-white/40 text-sm leading-relaxed">
                    We capture the laughs, the dances, and the unposed moments that show how much fun your party really was.
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="text-orange-500"><Clock size={20} /></div>
                  <h4 className="text-[11px] uppercase tracking-widest font-bold text-white">Quick Updates</h4>
                  <p className="text-white/40 text-sm leading-relaxed">
                    Get your best shots back quickly so you can share your birthday highlights with friends and family.
                  </p>
                </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white/[0.03] p-6 md:p-10 border border-white/10 rounded-sm backdrop-blur-3xl lg:sticky lg:top-24">
              <h3 className="text-xl font-serif italic mb-6 md:mb-8 text-center lg:text-left">Event Details</h3>
              ...
              <button className="group w-full py-4 md:py-5 bg-white text-black hover:bg-orange-500 hover:text-white transition-all duration-500 uppercase text-[10px] tracking-[0.3em] font-black flex items-center justify-center gap-4">
                Check My Date <Send size={14} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              </button>
            </div>
          </motion.div>
      ...
      {/* GALLERY GRID - Constrained Image Sizes */}
      <section className="py-16 md:py-24 px-4 md:px-12">
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            ...
            <div className="aspect-square md:aspect-[3/4] bg-white/[0.02] border border-white/5 flex flex-col items-center justify-center p-8 md:p-12 text-center space-y-6">
                ...
                <p className="font-serif italic text-2xl md:text-3xl text-white/80 leading-tight">Celebrate your day, we'll handle the memories.</p>
            ...
            >
              <img 
                src="https://disneystories.lk/wp-content/uploads/2023/04/146.jpg" 
...
export default function BDShoot() {
  return (
    <ServiceDetailTemplate 
      ...
      image="https://disneystories.lk/wp-content/uploads/2023/04/146.jpg"
      description="Celebrate your special day with high-energy photos. We capture every real smile and all the excitement of your party so you can relive the joy forever."
    />
  );
}