...
const Artist = () => {
  ...
  // 1. High-Performance Mouse Tracking (No State)
  ...
  return (
    ...
    >
      ...
      {/* Glow Layer: Uses style prop for performance */}
      <motion.div
      ...
      {/* Silhouette: Uses willChange to trigger GPU acceleration */}
      <motion.div 
        style={{ y: pngY, x: useTransform(springX, (val) => val * -1), willChange: "transform" }}
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.02] mix-blend-overlay [background-image:url('https://grainy-gradients.vercel.app/noise.svg')]" />
    </section>
  );
};
